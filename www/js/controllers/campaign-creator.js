...
var helpers = require('../helpers/campaign-creator');


var CampaignCreatorController = /*@ngInject*/ function($scope, $location, $timeout, dioData, dioAPI) {
  // TODO(leah): Nitpicks:
...
module.exports = CampaignCreatorController;
